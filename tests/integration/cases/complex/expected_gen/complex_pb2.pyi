...
class MessageOptional(google.protobuf.message.Message):
    ...
    def __init__(self, *, f1: builtins.str, f2: typing.Optional[builtins.str]=None) -> None:...
    ...
    def HasField(self, field_name: typing.Literal['f2']) -> bool:...
...
class MessageWithMultipleOneOfs(google.protobuf.message.Message):
    ...
    def __init__(self, *, v1: builtins.str, v2: builtins.str, v3: builtins.str, v4: builtins.str) -> None:...
