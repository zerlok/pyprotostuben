...
class MessageOptional(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal['optmsg']) -> builtins.bool:...
...
class CombinedMessage(google.protobuf.message.Message):

    def __init__(self, *, msg1: typing.Sequence[Message1], msg2: typing.Optional[Message2]=None, seq: typing.Sequence[MessageOptional], root: typing.Optional[NestedRoot]=None) -> None:...

    @builtins.property
    def msg1(self) -> typing.Sequence[Message1]:...

    @builtins.property
    def msg2(self) -> Message2:...

    @builtins.property
    def seq(self) -> typing.Sequence[MessageOptional]:...

    @builtins.property
    def root(self) -> NestedRoot:...

    def HasField(self, field_name: typing.Literal['msg2', 'root']) -> builtins.bool:...
